...
@Component({
  selector: 'app-cobertura-eng',
  templateUrl: './cobertura-eng.component.html',
  styleUrls: ['./cobertura-eng.component.css']
})
export class CoberturaEngComponent implements OnInit {
